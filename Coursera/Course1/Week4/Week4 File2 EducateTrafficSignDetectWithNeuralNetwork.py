...
try:
	...
	def params_verification(params):
		...
		numeric_params = {"m", "learning_rate", "num_iterations"}
	...
	if __name__ == '__main__':
		...
		parameters = log_and_run(intialize_deep_params_with_random, "Initialize W and b params", parameters)
		
		parameters["num_iterations"] = 1001
